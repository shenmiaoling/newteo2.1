  ...
  render(){
    return <div className='container'>
      ...
      <table className="table table-bordered">
        ...
        <tbody>
          <tr>
            <th scope="row" rowSpan="5" className='category'>基本功能</th>
            <td className='model'>通用</td>
            <td>
              <Checkbox label="APP logo 和启动页面" updateCount={this.updateCount}/>
              <Checkbox label="引导" updateCount={this.updateCount}/>
              <Checkbox label="版本和升级" updateCount={this.updateCount}/>
              <Checkbox label="帮助和意见反馈" updateCount={this.updateCount}/>
              <Checkbox label="关于我们" updateCount={this.updateCount}/>
              <Checkbox label="分享和应用打分" updateCount={this.updateCount}/>
            </td>
          </tr>
          <tr>
            <th className='model'>注册登录</th>
            <td>
          ...
          <tr>
            ...
            <td>
              <Checkbox label="APP 通知推送" updateCount={this.updateCount}/>
          ...
          <tr>
            <th scope="row" rowSpan='3' className='category'>社交功能</th>
          ...
          <tr>
            <td className='model'>即时通讯</td>
            <td>
              <Checkbox label="即时聊天" updateCount={this.updateCount}/>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <th className='model'>多客户端</th>
            <td>
              <Checkbox label="需要" updateCount={this.updateCount}/>
            </td>
          </tr>
          <tr>
      ...
      <div className='row'>
        ...
        <div className='col-xs-6 col-sm-6 col-md-6 col-xl-6 col-lg-6'>
          <Link to='/evaluation/android/result'>
