    ...
    return <div className='container'>
      ...
      <div className='row table-result'>
        <div className='col-lg-12 col-xl-12 col-xs-12 col-sm-12 col-md-12'>
          <h4 className='price'>{calculation(this.state.total,this.state.count).finalPrices}</h4>
        </div>
        <div className='col-lg-12 col-xl-12 col-xs-12 col-sm-12 col-md-12'>
          <h6 className='predict-time'>预计开发周期：{calculation(this.state.total,this.state.count).term}</h6>
        </div>
